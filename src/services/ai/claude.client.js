...
const TOOL = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      horario_visita: {
        type: ['string', 'null'],
        description: 'Só quando o lead ESCOLHEU um dos horários de <horarios_disponiveis>: copie exatamente o id (data e hora ISO) desse horário. Senão null.',
      },
...
const outputSchema = z.object({
  ...
  horario_visita: z.string().max(40).nullable().optional(),
...
function toInternal(o) {
  ...
  return {
    ...
    visitSlot: o.horario_visita ? String(o.horario_visita).trim() : null,
